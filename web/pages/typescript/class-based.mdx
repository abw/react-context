...
single type for your props and use a utility type to selectively convert the
relevant values from optional to required.
...
The `WithRequired` utility type on line 1 is used to convert the

...
<div className="warning alert border">
  <h3>Warning!</h3>
  This documentation describes the `Generator` function.  It still works
  perfectly well as it always has done.  But it has been superceded by the
  `Model` function for new code.

  I haven't got around to updating the documentation yet.  This is a reminder

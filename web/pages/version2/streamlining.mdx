import App        from '@/web/lib/Volume/App.jsx'
import AppSrc     from '@/web/lib/Volume/App.jsx?raw'
import VolumeSrc  from '@/web/lib/Volume/Volume.js?raw'
import ButtonsSrc from '@/web/lib/Volume/Buttons.jsx?raw'
...
appropriately named `generated` variable. In lines 10 to 23 we deconstruct

...
And here's another one which renders some buttons to increment or decrement
the count in steps of 1 or 10.
...
If you're using the `Use` hook to access the context properties then the
typing is automatic.
